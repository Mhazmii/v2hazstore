...
tempat_tinggal = ["tempat tinggal saya di mesin :)","jangan tanya mulu Hazstore lagi pms"]
jadi = ["Saya mau menjadi pacarmu kok","ya mau dong hehe","ya mau lah","Hazstore mau kok","Mau dong"]
...
rindu2 = ["jangan rindu kamu gaakan kuat biar Hazstore saja","Hazstore juga rindu :("]
